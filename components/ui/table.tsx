...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-[#1E293B]/70", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[#1E293B]/70 transition-colors hover:bg-[#1E293B]/50 data-[state=selected]:bg-[#1E293B]",
      className
    )}
    {...props}
  />
